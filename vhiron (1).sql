...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2022 at 06:53 AM
...
CREATE TABLE `tbllogin` (
  `tbllogin_SrNo` int(11) NOT NULL,
  `tbllogin_EmployeeId` int(11) NOT NULL,
  `tbllogin_EmployeeFirstName` varchar(50) NOT NULL,
  `tbllogin_EmployeePassword` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `tbllogin`
  ADD PRIMARY KEY (`tbllogin_SrNo`),
  ADD KEY `tbllogin_EmployeeId` (`tbllogin_EmployeeId`);
...
--
ALTER TABLE `tbllogin`
  ADD CONSTRAINT `tbllogin_ibfk_1` FOREIGN KEY (`tbllogin_EmployeeId`) REFERENCES `tbllogin` (`tbllogin_SrNo`);
COMMIT;
